...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        fputs("------------Your Receipt------------\n",out);
        fputs("Show Name : Avengers EndGame\n",out);
...
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        FILE *out=fopen("Reciept.txt","w");
        fputs("------------Your Receipt------------\n",out);
        fputs("Show Name : Captain Marvel\n",out);
        fprintf(out,"Customer Name:%s\n",name);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
         FILE *out=fopen("Reciept.txt","w");
        fputs("------------Your Receipt------------\n",out);
        fputs("Show Name : Spider-Man: Far From Home\n",out);
        fprintf(out,"Customer Name:%s\n",name);
